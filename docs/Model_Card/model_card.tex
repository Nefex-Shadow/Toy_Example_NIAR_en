...
% TITLE, change here
\begin{tcolorbox}[title=\textbf{Model Card - NIAR Toy Example},
...
\begin{mcsection}{Model Details}
    \item This model was developed by Luís Eduardo Limas Brito, 27/02/2026.
...
\begin{mcsection}{Training Data}
    ...
    \item Read \textit{data\_card.md} for more detailed information on the dataset and the pre-processing.
\end{mcsection}
...
\begin{mcsection}{Ethical Considerations}
    \item A fairness study showed some disparity in prediction quality between some sensitives groups (mainly regional and hospital size). For more information, read \textit{fairness\_report.md}.
\end{mcsection}
...
\begin{mcsection}{Caveats and Recommendations}
    ...
    \item For extra, detailed information in different aspects of the Responsible AI dimension, many documents can be found in the "docs/" and "audit/" folders explaining the methods implemented in the notebook and analysing the results.
\end{mcsection}
